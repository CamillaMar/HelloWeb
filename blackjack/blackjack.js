...
start.addEventListener("click", () => {
    ...
    board.insertBefore(gameContainer, btnContainer);

    gameContainer.append(computer.playerContainer, player.playerContainer,  endGame);
    btnContainer.append(hitBtn, standBtn);
